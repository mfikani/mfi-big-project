package mfi.old_packages.javareferences;
 ...
 *
 */
public class TutorialStrongWeakReference {

	public static void main(String[] args) {
		
		//1-STRONG Reference ( normal reference, used always ) 
		...
		for(int i=0;i < count; i++){
			...
			//Find out if the WeakWidget is still there of has it been GD'd 
			if(ww == null){
				System.out.println("Oops WeakWidget "+i+" was garbage collection. <<<<< ");
			}else{
				System.out.println("Awsome WeakWidget "+i+" is still around. Let's use it");
			}
		}
	}
